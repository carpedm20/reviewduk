"""
Django settings for reviewduk project.
...
SECRET_KEY = '3gs$=o4pe7(foa$1yh0^wac^-$&90m=6vyglu(_+6v9cigr=_='
MODEL_DIR = 'vw_models'
...
ROOT_URLCONF = 'reviewduk.urls'

WSGI_APPLICATION = 'reviewduk.wsgi.application'
